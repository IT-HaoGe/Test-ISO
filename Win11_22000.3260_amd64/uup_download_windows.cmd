@echo off
:: Generated on 2026-01-25 15:18:15 GMT
...
:START_PROCESS
title 22000.3260_amd64_zh-tw_professional_35630b7b download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=35630b7b-4509-45b6-83a1-d4c75d5aa9b6&pack=zh-tw&edition=professional&aria2=2"
