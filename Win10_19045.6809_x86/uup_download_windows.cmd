@echo off
:: Generated on 2026-01-14 02:51:31 GMT
...
:START_PROCESS
title 19045.6809_x86_zh-cn_multi_30803121 download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=30803121-e32e-4142-ac51-a96259db56dd&pack=zh-cn&edition=professional%%3Bcorecountryspecific%%3Bcore&aria2=2"
