@echo off
:: Generated on 2026-01-18 03:59:48 GMT
...
:START_PROCESS
title 19045.6811_amd64_zh-cn_multi_3671e4cd download
...
"%aria2%" --no-conf --async-dns=false --console-log-level=warn --log-level=info --log="aria2_download.log" -o"%aria2Script%" --allow-overwrite=true --auto-file-renaming=false "https://uupdump.net/get.php?id=3671e4cd-b7f1-4aa7-987a-ec2dbb82d0f3&pack=zh-cn&edition=professional%%3Bcorecountryspecific%%3Bcore&aria2=2"
